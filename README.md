...
I’m a Full Stack Developer with ~2 years of experience designing and building production-ready web applications using modern JavaScript technologies.
...
### 🚗 OmniQ – Car Rental SaaS Platform
- Full-stack booking system with real-time availability
- Role-based dashboards (Admin / Agent / Customer)
- Secure authentication & payment integration

### 🏢 PropSuite – Real Estate Management System
- Multi-role SaaS platform for property management
- Optimized media handling (40% faster load time)
- Scalable architecture supporting concurrent users

### 🛒 Lumivance – E-commerce Web Application
- High-performance online store (Lighthouse 95+)
- Admin dashboard for products, orders, users
- Integrated payment gateway & image optimization

### 🤖 ApplyWise – AI Resume Optimizer
...
- ✅ Production-level SaaS development experience  
- ✅ Strong frontend architecture (React / Next.js)  
- ✅ API design & integration expertise  
...
- 🌐 Portfolio: https://syednoor.vercel.app  
- 💼 LinkedIn: https://linkedin.com/in/shaednoor  
